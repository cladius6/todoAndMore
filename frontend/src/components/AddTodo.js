	...
	return (
        ...
        <Tooltip hasArrow label='Press enter to add quickly'>
			<Input autoFocus 
                    ...
                    size='lg' 
                    borderRadius='0' 
                    variant='flushed' placeholder='Name' onChange={e => setContent(e.target.value)}/>
        </Tooltip>
        <Tooltip hasArrow label='Add with more informations.'>
			<Button leftIcon={<AddIcon />} fontSize='32px' variant='ghost' size='lg' textTransform='uppercase' borderRadius='0' colorScheme='teal' onClick={addTodoHandler}>Add
        </Button>
        </Tooltip>
        </Box>
        </form>
